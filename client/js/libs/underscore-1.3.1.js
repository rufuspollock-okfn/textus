...
(function() {
	...
	_.reduceRight = _.foldr = function(obj, iterator, memo, context) {
		...
		if (context && !initial)
			iterator = _.bind(iterator, context);
		return initial ? _.reduce(reversed, iterator, memo, context) : _
	...
	// Especially useful on the arguments object. Passing an **index** will
	// return
