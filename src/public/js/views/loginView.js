								...
								presenter
										.getCurrentUser(function(user) {
											...
											if (user.loggedin) {
												...
												$i
														.append("<div class='textus-label'>User :</div><div class='user-name'>"
																+ user.details.id + "</div>");
												...
												$l
														.append(
																form.el,
																"<button id='loginButton'>Log In</button><button id='lostPasswordButton'>Lost PW</button>",
																"<div class='login-links'><a href='#register'>Register</a></div>");
												$('#loginButton').bind("click", function() {
													presenter.login(form.getValue().user, form.getValue().password);
												});
												$('#lostPasswordButton').bind("click", function() {
													presenter.lostPassword(form.getValue().user);
												});
											}
										});
							}
